...
{
    public partial class Reporte_TransferenciaPartes : DevExpress.XtraReports.UI.XtraReport
    {
        public Reporte_TransferenciaPartes()
        {
            InitializeComponent();
        ...
        private void Reporte_TransferenciaPartes_DataSourceDemanded(object sender, EventArgs e)
        {
