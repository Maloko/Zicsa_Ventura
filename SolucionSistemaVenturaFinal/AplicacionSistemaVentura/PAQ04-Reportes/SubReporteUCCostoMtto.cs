...
{
    public partial class SubReporteUCCostoMtto : DevExpress.XtraReports.UI.XtraReport
    {
        public SubReporteUCCostoMtto()
        {
            InitializeComponent();
        }

        private void SubReporteUCCostoMtto_DataSourceDemanded(object sender, EventArgs e)
        {
